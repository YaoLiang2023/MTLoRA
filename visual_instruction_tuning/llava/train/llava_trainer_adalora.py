...
class LLaVAAdaLoRATrainer(Trainer):
    ...
    def _inner_training_loop(
        ...
        # self.model.base_model.set_total_step(max_steps)
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        if getattr(self.args, 'tune_mm_mlp_adapter', False):
            ...
            super(LLaVAAdaLoRATrainer, self)._save_checkpoint(model, trial, metrics)

    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        if getattr(self.args, 'tune_mm_mlp_adapter', False):
            pass
        else:
            super(LLaVAAdaLoRATrainer, self)._save(output_dir, state_dict)
